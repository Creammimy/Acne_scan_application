...
3.โฟลเดอร์ model คือ model ที่ใช้ในการวิเคราะห์สิว พัฒนาด้วย yolov12 ภายในโฟลเดอร์ ตัวโมเดลจะอยู่ที่ Model>weights>best.pt ส่วนอื่นจะคือรายงานผลลัพธืต่างๆของโมเดล